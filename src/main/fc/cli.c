...
// PG_VTX_CONFIG
#ifdef VTX_COMMON
    { "vtx_device",                VAR_UINT8  | MASTER_VALUE, .config.minmax = { 0, 4 }, PG_VTX_CONFIG, offsetof(vtxConfig_t, vtx_mode) },
    ...
    { "vtx_power",                  VAR_UINT8  | MASTER_VALUE, .config.minmax = { 1, 5 }, PG_VTX_CONFIG, offsetof(vtxConfig_t, vtx_power) },
#endif
